const TicketPurchaseCard = (props) => {
  return (
    <svg viewBox="0 0 296 121" {...props}>
      <g filter="url(#filter0_dd_ticket_purchase_card)">
        <path d="M4 16C4 7.16344 11.1634 0 20 0H66V113H20C11.1634 113 4 105.837 4 97V16Z" fill="#FFFFFF" />
        <path
          fillRule="evenodd"
          clipRule="evenodd"
          ...
          fill="#FFFFFF"
        />
        <rect x="66" y="10" width="10" height="93" fill="#FFFFFF" />
        <path d="M78 103V10" stroke="#FFFFFF" strokeWidth="4" strokeDasharray="4 4" />
        <rect x="80" y="10" width="10" height="93" fill="#FFFFFF" />
        <path
          fillRule="evenodd"
          clipRule="evenodd"
          ...
          fill="#FFFFFF"
        />
        <path d="M90 0H276C284.837 0 292 7.16344 292 16V97C292 105.837 284.837 113 276 113H90V0Z" fill="#FFFFFF" />
      </g>
      <defs>
        <filter
