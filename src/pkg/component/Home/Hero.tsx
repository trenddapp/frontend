...
import { Terminal } from 'pkg/component/Terminal'

const HeroBackground = styled(Box)`
  display: none;
  ${({ theme }) => theme.mediaQueries.md} {
    background-image: url('/background-full.svg');
...
const HeroBackgroundLeft = styled(Box)`
  background-image: url('/background-left.svg');
...
const HeroBackgroundRight = styled(Box)`
  background-image: url('/background-right.svg');
...
const HeroFinal = styled(Box)`
  display: none;
  ${({ theme }) => theme.mediaQueries.md} {
    background-image: url('/background-triangle.svg');
    background-position-x: center;
    background-position-y: bottom;
    background-repeat: no-repeat;
    background-size: 100%;
